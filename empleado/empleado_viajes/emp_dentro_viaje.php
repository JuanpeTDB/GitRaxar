...
<head>
    ...
    <title>REMI</title>
    <link rel="stylesheet" type="text/css" href="css/emp_dentro_viajes.css">
</head>
<body>
    <header>
		<img class="logo" src="img/REMI_completo.png">
        <a href="emp_ver_viajes.php" class="btnatras">ATRAS</a>
	</header>
    ...
    <div class="contenedor">
        ...
        <div class="acciones">
            ...
            <button style="margin-left: 40px" onclick="window.location.href='emp_editar_viaje.php';">
