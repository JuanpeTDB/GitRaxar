...
<a style="text-decoration: none;" href="../../admin.php">
    ...
    <div class="dropdown" style="">
        ...
        <a class="opc" href="../admin_lista_negra/adm_listanegra.php" class="nav-link">Lista Negra</a>
        ...
        <div class="container">
                <div class="card" id="chofer" onclick="window.location.href='adm_ver_viajes.php?filtro=0';">
                    ...
                    <div class="back">
                        ...
                        <p class="txt">En esta sección se encuentran las viajes registrados en el sistema.</p>
                    </div>
                </div>
            </div>
        <div class="container">
            <div class="card" id="chofer" onclick="window.location.href='adm_agendar_viaje.php';">
                <div class="front">
                ...
                <div class="back">
                    <h2 class="h2-back">Agendar viajes</h2>
                        <p class="txt">En esta sección se pueden agendar los viajes.</p>
                </div>
            </div>
        </div>
    </div>
