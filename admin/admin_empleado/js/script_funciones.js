$(document).ready(function() {
    ...
    function getAll() {
        $.ajax({
            ...
            success: function(response) {
                let Empleadoes = JSON.parse(response);
                let ret = '';
                console.log(JSON.parse(response));
                Empleadoes.forEach(res => {
                    ret += `
						<tr cod="${res.ci}">
    ...
    $(document).on("click", ".btneliminar", function() {
        ...
        contenido.append("<p class='parrafoElim'>¿Seguro que deseas eliminar al empleado del sistema?</p>");
    ...
    $(document).on('click', '.btnInfo', function() {
        var ci = $(this).data("ci");
        window.location.href = "adm_dentro_empleado.php?ci=" + ci;
    });
