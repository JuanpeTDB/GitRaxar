...
<head>
    ...
    <title>REMI</title>
    <link rel="stylesheet" type="text/css" href="css/estilo_adm_dentro_coche.css">
</head>
<body>
    <header>
    ...
    <div class="contenedor">
        ...
        <div class="acciones">
            <button style="margin-left: 60px" id="btneliminar">
                <img src="img/eliminar.png" class="imgboton">
            </button>
            <button style="margin-left: 20px" onclick="window.location.href='adm_editar_coche.php';">
                <img src="img/editar.png" class="imgboton">
            </button>
            <button style="margin-left: 20px" onclick="window.location.href='adm_viajes_coche.php';">
